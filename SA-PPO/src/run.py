...
def add_common_parser_opts(parser):
    ...
    # Random Projection (RP) parameters
    parser.add_argument('--rp-dim-factor', type=int, default=1.0, help='Exponent for random projection dimension')
    parser.add_argument('--rp-lambda', type=float, default=1e-4, help='Strength of random projection regularization')
