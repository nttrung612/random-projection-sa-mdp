...
def main(args):
    ...
    proj_dim = training_config.get('rp_dim', 8192)
    proj_lambda = training_config.get('rp_lambda', 1.0)


    current_model = model_setup(env_id, env, robust_model, logger, USE_CUDA, dueling, model_width, proj_dim, proj_lambda)
    target_model = model_setup(env_id, env, robust_model, logger, USE_CUDA, dueling, model_width, proj_dim, proj_lambda)
